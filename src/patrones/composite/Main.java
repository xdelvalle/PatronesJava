...
/**
 * Patrón Composite: Crea una estructura en arbol de un grupo de objetos en un solo objeto que la contiene
 *
 * http://www.java2s.com/Tutorials/Java/Java_Design_Patterns/0090__Java_Composite_Pattern.htm
 */
public class Main {
